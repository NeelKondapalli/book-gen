...
1. A clear thesis statement focusing on how each of the three novels addresses social isolation.
...
----------------------------------------------------------------
- The report should compare how each book handles the theme of social isolation.
...
Additionally, here is the user’s own specific request or focus:
----------------------------------------------------------------
{USER_PROMPT}
----------------------------------------------------------------
...
CONTEXT_PROMPT = """
You have the following outline for a 5-paragraph essay comparing how each of the three novels addresses the theme of social isolation:
...
Each query should:
- Aim to enrich the discussion on social isolation.
- Target relevant scenes, quotes, or details that connect directly to the outline’s key points (e.g., Gregor’s transformation in *The Metamorphosis*, Sylvia Plath’s social expectations in *The Bell Jar*, Camus’s depiction of existential detachment in *The Stranger*).
...
- AGAIN make sure the essay is AT LEAST 600 words
...
Deliver a single, continuous text output of exactly five paragraphs. No additional formatting or commentary should be included outside of these paragraphs.
"""